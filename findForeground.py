...
GetCaptureProperty, CV_CAP_PROP_FRAME_WIDTH, CV_CAP_PROP_FRAME_HEIGHT, GetSize
...
#                     int(GetCaptureProperty(cap, CV_CAP_PROP_FRAME_HEIGHT)))
    ...
    def findForeground(self, source):  #This should operate on real-time camera input.
